...
|------|---------|--------|
| `00a-*` | Cover | LaTeX cover page with graphics |
| `00b-*` | Introduction | Hook, manifesto, mission statement |
| `00c-*` | About Author | Identity, collaboration, transparency |
| `00d-*` | Behind Scenes | Process, cost, meta-commentary |
| `00e-*` | Reader's Guide | How to use, legend, family notes |
